...
HD_PWD='d:/consultancy/vimanic/spicontroller/ip_repo/edit_ad9361SPI_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad9361SPI_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad9361SPI_v1_0.tcl

...
proc create_hier_cell_ProcessorSystem { parentCell nameHier } {
  ...
  create_bd_pin -dir I spi1_clk_i
  create_bd_pin -dir O spi1_clk_o
  create_bd_pin -dir O spi1_csn_0_o
  create_bd_pin -dir O spi1_csn_1_o
  create_bd_pin -dir O spi1_csn_2_o
  create_bd_pin -dir I spi1_csn_i
  create_bd_pin -dir I spi1_sdi_i
  create_bd_pin -dir I spi1_sdo_i
  create_bd_pin -dir O spi1_sdo_o
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#UART 1#UART 1#SD 0#GPIO#GPIO#GPIO}\
  ...
  connect_bd_net -net spi1_clk_i_1 [get_bd_pins spi1_clk_i] [get_bd_pins sys_ps7/SPI1_SCLK_I]
  ...
  connect_bd_net -net sys_ps7_SPI1_MOSI_O [get_bd_pins spi1_sdo_o] [get_bd_pins sys_ps7/SPI1_MOSI_O]
  connect_bd_net -net sys_ps7_SPI1_SCLK_O [get_bd_pins spi1_clk_o] [get_bd_pins sys_ps7/SPI1_SCLK_O]
  connect_bd_net -net sys_ps7_SPI1_SS1_O [get_bd_pins spi1_csn_1_o] [get_bd_pins sys_ps7/SPI1_SS1_O]
  connect_bd_net -net sys_ps7_SPI1_SS2_O [get_bd_pins spi1_csn_2_o] [get_bd_pins sys_ps7/SPI1_SS2_O]
  connect_bd_net -net sys_ps7_SPI1_SS_O [get_bd_pins spi1_csn_0_o] [get_bd_pins sys_ps7/SPI1_SS_O]
...
proc create_hier_cell_LVDSIF { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net amModulator_0_o_amSignal [get_bd_pins i_Channel_1_I_Value] [get_bd_pins dataPackager_0/i_Channel_1_I_Value]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dataPackager_0/i_Channel_1_Q_Value] [get_bd_pins dataPackager_0/i_Channel_2_I_Value] [get_bd_pins dataPackager_0/i_Channel_2_Q_Value] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_I2SSystem { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins i_mclk] [get_bd_pins i2sController_1/i_mclk]
  ...
  connect_bd_net -net sys_cpu_clk [get_bd_pins sys_cpu_clk_out] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins i2sController_1/i_clk]
...
proc create_hier_cell_AMModulate { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 11 -to 0 o_angle1
  ...
  # Create instance: angleLUT_0, and set properties
  set block_name angleLUT
  set block_cell_name angleLUT_0
  if { [catch {set angleLUT_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $angleLUT_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: baseBandLUT, and set properties
  set block_name angleLUT
  set block_cell_name baseBandLUT
  if { [catch {set baseBandLUT [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $baseBandLUT eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net baseBandLUT_o_angle [get_bd_pins o_angle1] [get_bd_pins amModulator_0/i_baseband] [get_bd_pins baseBandLUT/o_angle]
...
proc create_hier_cell_AMDemodulate { parentCell nameHier } {
  ...
  create_bd_pin -dir O o_data_valid
  create_bd_pin -dir O o_data_valid1
  ...
  connect_bd_net -net decimation_0_o_data [get_bd_pins o_data1] [get_bd_pins decimation_0/o_data] [get_bd_pins envelopDetector_0/i_data]
  connect_bd_net -net decimation_0_o_data_valid [get_bd_pins o_data_valid1] [get_bd_pins decimation_0/o_data_valid] [get_bd_pins envelopDetector_0/i_data_valid]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets decimation_0_o_data_valid]
  ...
  connect_bd_net -net envelopDetector_0_o_data_valid [get_bd_pins o_data_valid] [get_bd_pins envelopDetector_0/o_data_valid] [get_bd_pins fir_compiler_0/s_axis_data_tvalid]
  ...
  connect_bd_net -net i_data_1 [get_bd_pins i_data] [get_bd_pins decimation_0/i_data]
  connect_bd_net -net i_data_valid_1 [get_bd_pins i_data_valid] [get_bd_pins decimation_0/i_data_valid]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_0 [ create_bd_port -dir I clk_0 ]
  set clk_1 [ create_bd_port -dir I clk_1 ]
  ...
  set o_le_1 [ create_bd_port -dir O o_le_1 ]
  set o_le_2 [ create_bd_port -dir O o_le_2 ]
  set o_le_3 [ create_bd_port -dir O o_le_3 ]
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {455.129} \
   CONFIG.CLKOUT1_PHASE_ERROR {318.151} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {25.625} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {52.125} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ProcessorSystem_M00_AXI [get_bd_intf_pins ProcessorSystem/M00_AXI] [get_bd_intf_pins attenuatorController_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net AMModulate_o_angle [get_bd_pins AMModulate/o_angle] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net AMModulate_o_angle1 [get_bd_pins AMModulate/o_angle1] [get_bd_pins system_ila_0/probe2]
  ...
  connect_bd_net -net LVDSIF_clk_out [get_bd_pins AMDemodulate/aclk] [get_bd_pins LVDSIF/clk_out] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net attenuatorController_0_o_clk [get_bd_ports o_clk_attenuator] [get_bd_pins attenuatorController_0/o_clk] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net attenuatorController_0_o_data [get_bd_ports o_data_attenuator] [get_bd_pins attenuatorController_0/o_data] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net attenuatorController_0_o_le_1 [get_bd_ports o_le_1] [get_bd_pins attenuatorController_0/o_le_1] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net attenuatorController_0_o_le_2 [get_bd_ports o_le_2] [get_bd_pins attenuatorController_0/o_le_2] [get_bd_pins system_ila_0/probe6]
  ...
  connect_bd_net -net i_Channel_1_I_Value_1 [get_bd_pins AMModulate/o_amSignal] [get_bd_pins LVDSIF/i_Channel_1_I_Value] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets i_Channel_1_I_Value_1]
  ...
  connect_bd_net -net spi1_clk_i_1 [get_bd_ports spi1_clk_i] [get_bd_pins ProcessorSystem/spi1_clk_i]
  ...
  connect_bd_net -net sys_cpu_clk [get_bd_ports sys_cpu_clk_out] [get_bd_pins I2SSystem/sys_cpu_clk_out] [get_bd_pins ProcessorSystem/sys_cpu_clk_out] [get_bd_pins attenuatorController_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins vio_0/clk]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins I2SSystem/i_reset_n] [get_bd_pins ProcessorSystem/S00_ARESETN] [get_bd_pins attenuatorController_0/s00_axi_aresetn]
  ...
  connect_bd_net -net sys_ps7_SPI1_MOSI_O [get_bd_ports spi1_sdo_o] [get_bd_pins ProcessorSystem/spi1_sdo_o]
  connect_bd_net -net sys_ps7_SPI1_SCLK_O [get_bd_ports spi1_clk_o] [get_bd_pins ProcessorSystem/spi1_clk_o]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins AMModulate/enable] [get_bd_pins vio_0/probe_out0]

...
HD_PWD='E:/Projects/refSoM/refCC2/hw/vhfSystem.runs/system_vio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vio_1_0.tcl

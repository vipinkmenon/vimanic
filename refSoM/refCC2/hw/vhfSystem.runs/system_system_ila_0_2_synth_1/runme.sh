...
HD_PWD='E:/Projects/refSoM/refCC2/hw/vhfSystem.runs/system_system_ila_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_system_ila_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_system_ila_0_2.tcl

...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = I2SSystem_Audio_Amplifier_I2C
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.8
 PARAMETER HW_INSTANCE = I2SSystem_adau_1401_i2c
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.8
 PARAMETER HW_INSTANCE = I2SSystem_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.8
 PARAMETER HW_INSTANCE = ProcessorSystem_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = attenuatorController_0
END

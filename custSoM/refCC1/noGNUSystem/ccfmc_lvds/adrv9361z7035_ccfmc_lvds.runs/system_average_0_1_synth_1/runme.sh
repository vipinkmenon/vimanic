...
HD_PWD='E:/Projects/adrvSoM/vimanic/noGNUSystem/ccfmc_lvds/adrv9361z7035_ccfmc_lvds.runs/system_average_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_average_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_average_0_1.tcl

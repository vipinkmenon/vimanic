...
HD_PWD='F:/hdl-2021_r1/library/datapackagers/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dataPackager.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dataPackager.tcl

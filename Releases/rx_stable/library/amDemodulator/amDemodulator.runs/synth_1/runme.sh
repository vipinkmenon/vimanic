...
HD_PWD='F:/hdl-2021_r1/library/amDemodulator/amDemodulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log amDemodulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source amDemodulator.tcl
